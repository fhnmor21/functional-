...
public:
  ...
  Either(const Either& other) { Copy(other); }
  ...
  bool operator!=(const Either& rhs) const { return !operator==(rhs); }
  ...
  bool IsLeft() const { return _tag == ETag::LEFT; }

  bool IsRight() const { return _tag == ETag::RIGHT; }

  bool IsSet() const { return !(_tag == ETag::UNSET); }
