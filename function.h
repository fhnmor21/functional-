  ...
  namespace _dtl
  {
    ...
    struct function_manager_inplace_specialisation
    {
      ...
      static R call(const functor_padding& storage, Ps... ps)
      {
        ...
        return reinterpret_cast< T& >(const_cast< functor_padding& >(storage))(
            std::forward< Ps >(ps)...);
      }
        ...
        typename std::enable_if< !is_inplace_allocated< T, Allocator >::value >::type >
    {
      ...
      static R call(const functor_padding& storage, Ps... ps)
      {
        ...
        return (*reinterpret_cast< ptr_t& >(const_cast< functor_padding& >(storage)))(
            std::forward< Ps >(ps)...);
      }
      ...
      static void store_functor(manager_storage_type& self, T to_store)
      {
        ...
        ;
        static_assert(sizeof(ptr_t) <= sizeof(self.functor),
      ...
      static void move_functor(manager_storage_type& lhs, manager_storage_type&& rhs) noexcept
      {
        ...
        static_assert(std::is_nothrow_move_constructible< ptr_t >::value,
    ...
    void* function_manager(void* first_arg, void* second_arg, function_manager_calls call_type)
    {
      ...
      case call_copy:
      {
        ...
        specialisation::store_functor(lhs,
                                      const_cast< const T& >(specialisation::get_functor_ref(rhs)));
      ...
      case call_copy_functor_only:
        ...
        specialisation::store_functor(
            *static_cast< manager_storage_type* >(first_arg),
            const_cast< const T& >(specialisation::get_functor_ref(
    ...
    struct curried< R >
    {
      R operator()() const { throw(std::logic_error("Curried calling of parameterless function")); }
    };
    ...
    public:
      function< R(P2, Ps...) > operator()(P1 p1) const { return apply_one(std::move(p1)); }
